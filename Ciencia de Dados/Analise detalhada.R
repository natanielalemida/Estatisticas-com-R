...
library(plotly) #Biblioteca pra gerar visualizacoes mais sofisticadasi
...
ggplotly(g1) #este comando vem da biblioteca plotly. Passe o cursor do mouse no 
pontos do gráfico
#Visualiza a correlacao de Pearson entre as vendas e o preco do cafe
cor(dados$Vendas_Cafe, dados$Preco_Cafe) #Observe que é o mesmo valor que 
calculamos na apostila
