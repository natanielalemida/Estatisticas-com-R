...
hist(va_binomial) # A maior barra no histograma representa a quantidade esperadade vendas
...
#Qual a probabilidade da primeira venda ocorrer quando o quinto cliente entrar naloja?
...
va_geometrica
plot(va_geometrica) #Veja como as probabilidades vão diminuindo. A probabilidade
