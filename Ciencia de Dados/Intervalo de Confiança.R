...
paste("Com 95% de confiança, podemos afirmar que a média varia
...
paste("Com 95% de confiança, podemos afirmar que a média varia
entre",Limite_Inferior_t," e ",Limite_Superior_t)
...
bootstrap
R <- 1000 #Numero de subamostras extraídas para gerar a distribuição amostral de
médias
#bootstrap
for (i in 1:R) {
...
hist(medias)
#Observe que mesmo a variável original não seguindo uma distribuição normal, oTeorema Central do Limite

#nos garante que a distribuição das médias será normal se n é suficientementegrande
#A partir das médias geradas, precisamos achar dois valores, o que corta a cauda nferior
